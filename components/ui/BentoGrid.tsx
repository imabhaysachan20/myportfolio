...
import animationData from "@/data/landing/confetti.json";
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "imabhaysachan@gmail.com";
  ...
  return (
    ...
    <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-sans font-extralight text-[#c1d2d3] text-sm md:text-xs lg:text-base z-10">
          {description}
          </div>
