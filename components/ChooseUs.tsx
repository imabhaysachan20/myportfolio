  ...
  return (
    ...
    <div className='w-[60vw] z-50 h-[10vh] rounded mx-auto flex items-center justify-center'>
      <h2 className='text-7xl z-50 font-extrabold'>Why Choose <span className='text-purple'>Us?</span></h2>
        ...
        {features.map(({icon,title,description}:{icon:string,title:string,description:string})=>{return <div className='w-[80vw] md:w-[40vw] z-50 h-[25vh] rounded mx-auto flex flex-col items-center justify-center gap-y-4 bg-black-200 rounded-xl'>
